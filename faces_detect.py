...
output_dir = "/home/nallurn1/Anime_Code/avatar_crops"
...
for filename in os.listdir(input_dir):
    ...
    try:
        ...
        if image is None:
            raise ValueError(f"Failed to load image from file '{image_path}'")
    ...
    for i, (x, y, w, h) in enumerate(faces):
        ...
        # Save the cropped image to the output directory with an index in the filename
        output_filename = os.path.splitext(filename)[0] + f"_cropped_{i}.jpg"
